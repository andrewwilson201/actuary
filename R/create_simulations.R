...
#' params <- tibble(num_sims = 10e5, mean_freq = c(5, 2), sev_dist = c("lognorm2", "lognorm2"), sev_param1 = c(13, 6), sev_param2 = c(0.5, 0.7), label = c("typeA", "typeB"))
...
#' create_simulations(num_sims = 10e5, mean_freq = 5, sev_dist = "empirical", empirical = tibble(probability = c(0, 1), loss = c(5e6, 10e6)))
#' 
#' }
#' 
#' @export
